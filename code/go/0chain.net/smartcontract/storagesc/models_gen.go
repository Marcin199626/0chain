...
func (z *BlobberAllocation) Msgsize() (s int) {
	...
	s += 6 + z.Terms.Msgsize() + 14 + z.MinLockDemand.Msgsize() + 6 + z.Spent.Msgsize() + 8 + z.Penalty.Msgsize() + 11 + z.ReadReward.Msgsize() + 9 + z.Returned.Msgsize() + 16 + z.ChallengeReward.Msgsize() + 12 + z.FinalReward.Msgsize() + 27 + z.ChallengePoolIntegralValue.Msgsize()
	return
}
...
func (z *BlobberChallengeDecode) Msgsize() (s int) {
	s = 1 + 10 + msgp.StringPrefixSize + len(z.BlobberID) + 11 + msgp.ArrayHeaderSize
	for za0001 := range z.Challenges {
		if z.Challenges[za0001] == nil {
			s += msgp.NilSize
		} else {
...
func (z *ReadMarker) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// map header, size 11
	// string "ClientID"
	o = append(o, 0x8b, 0xa8, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x49, 0x44)
	o = msgp.AppendString(o, z.ClientID)
	...
	o = msgp.AppendString(o, z.Signature)
	// string "PayerID"
	o = append(o, 0xa7, 0x50, 0x61, 0x79, 0x65, 0x72, 0x49, 0x44)
	o = msgp.AppendString(o, z.PayerID)
	// string "AuthTicket"
	...
	o = msgp.AppendInt64(o, z.ReadSize)
	// string "ReadSizeInGB"
	o = append(o, 0xac, 0x52, 0x65, 0x61, 0x64, 0x53, 0x69, 0x7a, 0x65, 0x49, 0x6e, 0x47, 0x42)
	o = msgp.AppendFloat64(o, z.ReadSizeInGB)
	return
}
...
func (z *ReadMarker) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0001 > 0 {
		...
		case "PayerID":
			z.PayerID, bts, err = msgp.ReadStringBytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "PayerID")
				return
			}
		case "AuthTicket":
			if msgp.IsNil(bts) {
		...
		case "ReadSize":
			z.ReadSize, bts, err = msgp.ReadInt64Bytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "ReadSize")
				return
			}
		case "ReadSizeInGB":
			z.ReadSizeInGB, bts, err = msgp.ReadFloat64Bytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "ReadSizeInGB")
				return
			}
		default:
			bts, err = msgp.Skip(bts)
...
func (z *ReadMarker) Msgsize() (s int) {
	s = 1 + 9 + msgp.StringPrefixSize + len(z.ClientID) + 16 + msgp.StringPrefixSize + len(z.ClientPublicKey) + 10 + msgp.StringPrefixSize + len(z.BlobberID) + 13 + msgp.StringPrefixSize + len(z.AllocationID) + 8 + msgp.StringPrefixSize + len(z.OwnerID) + 10 + z.Timestamp.Msgsize() + 10 + msgp.StringPrefixSize + len(z.Signature) + 8 + msgp.StringPrefixSize + len(z.PayerID) + 11
	if z.AuthTicket == nil {
		s += msgp.NilSize
	} else {
		s += z.AuthTicket.Msgsize()
	}
	s += 9 + msgp.Int64Size + 13 + msgp.Float64Size
	return
}
...
func (z *StorageAllocationStats) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// string "ReadsSize"
	o = append(o, 0xa9, 0x52, 0x65, 0x61, 0x64, 0x73, 0x53, 0x69, 0x7a, 0x65)
	o = msgp.AppendInt64(o, z.ReadsSize)
...
func (z *StorageAllocationStats) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0001 > 0 {
		...
		case "ReadsSize":
			z.ReadsSize, bts, err = msgp.ReadInt64Bytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "ReadsSize")
				return
			}
...
func (z *StorageChallenge) MarshalMsg(b []byte) (o []byte, err error) {
	...
	for za0001 := range z.Validators {
		if z.Validators[za0001] == nil {
			...
			o = msgp.AppendString(o, z.Validators[za0001].ID)
			// string "BaseURL"
			o = append(o, 0xa7, 0x42, 0x61, 0x73, 0x65, 0x55, 0x52, 0x4c)
			o = msgp.AppendString(o, z.Validators[za0001].BaseURL)
			...
			o, err = z.Validators[za0001].StakePoolSettings.MarshalMsg(o)
			if err != nil {
				err = msgp.WrapError(err, "Validators", za0001, "StakePoolSettings")
				return
			}
		}
	}
	...
	for zb0001 > 0 {
		...
		case "Validators":
			...
			if cap(z.Validators) >= int(zb0002) {
				...
				z.Validators = make([]*ValidationNode, zb0002)
			}
			for za0001 := range z.Validators {
				if msgp.IsNil(bts) {
					bts, err = msgp.ReadNilBytes(bts)
					...
					if z.Validators[za0001] == nil {
						z.Validators[za0001] = new(ValidationNode)
					}
					var zb0003 uint32
					...
					for zb0003 > 0 {
						...
						switch msgp.UnsafeString(field) {
						case "ID":
							z.Validators[za0001].ID, bts, err = msgp.ReadStringBytes(bts)
							if err != nil {
								err = msgp.WrapError(err, "Validators", za0001, "ID")
								return
							}
						case "BaseURL":
							z.Validators[za0001].BaseURL, bts, err = msgp.ReadStringBytes(bts)
							if err != nil {
								err = msgp.WrapError(err, "Validators", za0001, "BaseURL")
								return
							}
						case "StakePoolSettings":
							bts, err = z.Validators[za0001].StakePoolSettings.UnmarshalMsg(bts)
							if err != nil {
								err = msgp.WrapError(err, "Validators", za0001, "StakePoolSettings")
								return
							}
...
func (z *StorageChallenge) Msgsize() (s int) {
	s = 1 + 8 + z.Created.Msgsize() + 3 + msgp.StringPrefixSize + len(z.ID) + 7 + msgp.StringPrefixSize + len(z.PrevID) + 11 + msgp.ArrayHeaderSize
	for za0001 := range z.Validators {
		if z.Validators[za0001] == nil {
			s += msgp.NilSize
		} else {
	...
	s += 13 + msgp.Int64Size + 13 + msgp.StringPrefixSize + len(z.AllocationID) + 8
	if z.Blobber == nil {
		s += msgp.NilSize
	} else {
		s += z.Blobber.Msgsize()
	}
	s += 15 + msgp.StringPrefixSize + len(z.AllocationRoot) + 9
	if z.Response == nil {
		s += msgp.NilSize
	} else {
...
func (z *StorageStats) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// map header, size 3
	// string "Stats"
	o = append(o, 0x83, 0xa5, 0x53, 0x74, 0x61, 0x74, 0x73)
	if z.Stats == nil {
		o = msgp.AppendNil(o)
	} else {
		o, err = z.Stats.MarshalMsg(o)
	...
	// string "LastChallengedSize"
	o = append(o, 0xb2, 0x4c, 0x61, 0x73, 0x74, 0x43, 0x68, 0x61, 0x6c, 0x6c, 0x65, 0x6e, 0x67, 0x65, 0x64, 0x53, 0x69, 0x7a, 0x65)
	o = msgp.AppendInt64(o, z.LastChallengedSize)
	// string "LastChallengedTime"
	o = append(o, 0xb2, 0x4c, 0x61, 0x73, 0x74, 0x43, 0x68, 0x61, 0x6c, 0x6c, 0x65, 0x6e, 0x67, 0x65, 0x64, 0x54, 0x69, 0x6d, 0x65)
	o, err = z.LastChallengedTime.MarshalMsg(o)
	if err != nil {
		err = msgp.WrapError(err, "LastChallengedTime")
		return
	}
	return
}
...
func (z *StorageStats) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0001 > 0 {
		...
		case "LastChallengedSize":
			z.LastChallengedSize, bts, err = msgp.ReadInt64Bytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "LastChallengedSize")
				return
			}
		case "LastChallengedTime":
			bts, err = z.LastChallengedTime.UnmarshalMsg(bts)
			if err != nil {
				err = msgp.WrapError(err, "LastChallengedTime")
				return
			}
...
func (z *StorageStats) Msgsize() (s int) {
	...
	s += 19 + msgp.Int64Size + 19 + z.LastChallengedTime.Msgsize()
	return
}
...
func (z *WriteMarker) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// map header, size 8
	// string "AllocationRoot"
	o = append(o, 0x88, 0xae, 0x41, 0x6c, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x6f, 0x6f, 0x74)
	o = msgp.AppendString(o, z.AllocationRoot)
...
func (z *WriteMarker) Msgsize() (s int) {
	s = 1 + 15 + msgp.StringPrefixSize + len(z.AllocationRoot) + 23 + msgp.StringPrefixSize + len(z.PreviousAllocationRoot) + 13 + msgp.StringPrefixSize + len(z.AllocationID) + 5 + msgp.Int64Size + 10 + msgp.StringPrefixSize + len(z.BlobberID) + 10 + z.Timestamp.Msgsize() + 9 + msgp.StringPrefixSize + len(z.ClientID) + 10 + msgp.StringPrefixSize + len(z.Signature)
	return
}
